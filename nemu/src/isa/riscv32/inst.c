...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, if(src2 == 0) R(rd) = src1; else R(rd) = src1 % src2);  //M
  ...
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = (int32_t)(((int64_t)(signed)src1 * (uint64_t)src2) >> 32));
